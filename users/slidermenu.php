  <!-- Side Menu -->
	...
	<!-- Component Start -->
	<div class="flex flex-col items-center w-40 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded hidden sm:block">
        ...
        <a class="flex items-center w-full h-12 px-3 mt-2 text-gray-400 bg-indigo-700 text-indigo-100 rounded" href="dashboard.php">
				...
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="sell.php">
				...
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="upload.php">
					...
					<span class="ml-2 text-sm font-medium">Uploads Payment</span>
				</a>
			</div>
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="withdraw.php">
					<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
					</svg>
					<span class="ml-2 text-sm font-medium">Withdraw</span>
				</a>
