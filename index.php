...
<style>
    ...
    .marquee div {
        ...
        animation: marquee 100s linear infinite; /* Increased duration to slow down */
    }
...
<div class="overflow-x-auto">
  <div class="md:flex justify-start mx-8 block" id="testimony-container">
    ...
    <div class="px-4 py-2">
      ...
      <div class="px-4 py-2">
        <p class="text-gray-600 text-sm italic">- David John</p>
      </div>
    </div>
    ...
    <div class="max-w-xs mx-2 my-4 bg-yellow-300 shadow-lg rounded-lg overflow-hidden testimony-card">
      ...
      <div class="px-4 py-2">
        <p class="text-gray-600 text-sm italic">- Ugo Chibuzo</p>
      </div>
    </div>
